...
export default function TermsOfUse() {
  return (
    <div className="c9 doc-content max-w-6xl mx-auto my-20 px-10 text-white">
      ...
      <p>
        These terms of use are entered into by and between You and Mirror World
        Inc. &nbsp;("<strong>Company</strong>," "<strong>we</strong>," or "
        <strong>us</strong>"). The following terms and conditions, together with
        any documents and addendums they expressly incorporate herein or by
        reference (collectively, "<strong>Terms of Use</strong>"), govern your
        access to and use of www.sonic.game, including any content,
        functionality and services offered on or through www.sonic.game (the "
      ...
      <p>
        ...
        <strong>, incorporated herein by reference.</strong>&nbsp;If you do not
        want to agree to these Terms of Use or the Privacy Policy, you must not
      ...
      <p>
        ...
        to check this page each time you access this Website so you are aware of
      ...
      <p>
        ...
        such material and are protected by local and international copyright,
      ...
      <ul>
        ...
        <li>
          You may print one copy of a reasonable number of pages of the Website
        ...
        <li>
          ...
          may download a single copy to your computer or mobile device solely
          for your own personal, non-commercial use, provided you agree to be
      ...
      <ul>
        ...
        <li>
          ...
          safety of users of the Website or the public or could create liability
          for the Company.
        </li>
        <li>
      ...
      <p>
        ...
        the Website, and cannot ensure prompt removal of objectionable material
      ...
      <p>
        ...
        with respect to the content they are displayed with. Subject to the
      ...
      <p>
        ...
        courts of the Cayman Islands. You waive any and all objections to the
      ...
      <p>
        ...
        arising from these Terms of Use or use of the Website, including
      ...
      <p>
        ...
        agreement between you and Mirror World Inc. with respect to the Website
      ...
      <p>
        ...
        content, functionality and services offered on or through Sonic Odyssey
        (the "<strong>Odyssey</strong>"), whether as a guest or a registered
        user.
      </p>
      <p>
        <span className="underline">
      ...
      <p>
        ...
        third parties. You must read and check with the terms of use prescribed
        by these third-party providers from time to time.
      </p>
      ...
      <p>
        ...
        reliability of the information presented, Odyssey makes no warranties or
        representations about the completeness, accuracy, or suitability of the
        tasks for any purpose.
      </p>
      <p>
      ...
      <p>
        ...
        claims, demands, or damages of any kind arising out of or in connection
        with the use of these tasks.
      </p>
    </div>
  );
}
